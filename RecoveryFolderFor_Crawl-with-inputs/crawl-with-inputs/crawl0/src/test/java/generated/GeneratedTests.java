...
/*
 * Generated @ Mon Oct 12 11:48:08 EDT 2020
 */
...
public class GeneratedTests {
	...
	private final String TEST_SUITE_PATH = "/home/icst20-awet/workspace/AWET/awet/applications/petclinic/localhost/crawl0/src/test/java/generated";
	...
	public void oneTimeSetUp(){
		try {
			...
			testSuiteHelper = new TestSuiteHelper(
					...
					"/home/icst20-awet/workspace/AWET/awet/applications/petclinic/localhost/crawl0/src/test/java/generated/states.json",
					"/home/icst20-awet/workspace/AWET/awet/applications/petclinic/localhost/crawl0/src/test/java/generated/eventables.json",
					"/home/icst20-awet/workspace/AWET/awet/applications/petclinic/localhost/crawl0/screenshots",
					"/home/icst20-awet/workspace/AWET/awet/applications/petclinic/localhost/crawl0/test-results",
					URL, TEST_SUITE_PATH);
		}
		catch (Exception e) {
	...
	public void method_1_12_13_14(){
		...
		try {
			...
			formInputs.add(new FormInput(FormInput.InputType.TEXT, new Identification(How.xpath, "/HTML[1]/BODY[1]/APP-ROOT[1]/APP-OWNER-ADD[1]/DIV[1]/DIV[1]/FORM[1]/DIV[3]/DIV[1]/INPUT[1]"), "Franklin"));
			formInputs.add(new FormInput(FormInput.InputType.TEXT, new Identification(How.id, "address"), "563 Friendly St."));
			formInputs.add(new FormInput(FormInput.InputType.TEXT, new Identification(How.id, "city"), "Sun Prairie"));
			formInputs.add(new FormInput(FormInput.InputType.TEXT, new Identification(How.id, "telephone"), "6085552765"));
	...
	public void method_5_6_18_19_20_21_22(){
		...
		try {
			...
			/* Eventable{eventType=click, identification=xpath //FORM[@id = 'specialty']/DIV[2]/DIV[1]/BUTTON[1], element=Element{node=[BUTTON: null], tag=BUTTON, text=Save, attributes={_ngcontent-c5=, class=btn btn-default, type=submit}}, source=StateVertexImpl{id=28, name=state28}, target=StateVertexImpl{id=29, name=state29}} */
			formInputs = new ArrayList<FormInput>();
			formInputs.add(new FormInput(FormInput.InputType.TEXT, new Identification(How.xpath, "/HTML[1]/BODY[1]/APP-ROOT[1]/APP-SPECIALTY-LIST[1]/DIV[1]/DIV[1]/DIV[1]/APP-SPECIALTY-ADD[1]/DIV[1]/DIV[1]/FORM[1]/DIV[2]/DIV[1]/DIV[1]/INPUT[1]"), "dentistry"));
			testSuiteHelper.handleFormInputs(formInputs);
			Thread.sleep(100);
			...
			/* Eventable{eventType=click, identification=xpath //TABLE[@id = 'specialties']/TBODY[1]/TR[1]/TD[2]/BUTTON[1], element=Element{node=[BUTTON: null], tag=BUTTON, text=Edit, attributes={_ngcontent-c4=, class=btn btn-default}}, source=StateVertexImpl{id=29, name=state29}, target=StateVertexImpl{id=30, name=state30}} */
			formInputs = new ArrayList<FormInput>();
			formInputs.add(new FormInput(FormInput.InputType.TEXT, new Identification(How.id, "0"), "GfapZhlW"));
			testSuiteHelper.handleFormInputs(formInputs);
			Thread.sleep(100);
			...
			/* Eventable{eventType=click, identification=xpath //FORM[@id = 'specialty']/DIV[2]/DIV[1]/BUTTON[1], element=Element{node=[BUTTON: null], tag=BUTTON, text=Update, attributes={_ngcontent-c6=, class=btn btn-default, type=submit}}, source=StateVertexImpl{id=30, name=state30}, target=StateVertexImpl{id=31, name=state31}} */
			formInputs = new ArrayList<FormInput>();
			...
			/* Eventable{eventType=click, identification=xpath //TABLE[@id = 'specialties']/TBODY[1]/TR[1]/TD[2]/BUTTON[2], element=Element{node=[BUTTON: null], tag=BUTTON, text=Delete, attributes={_ngcontent-c4=, class=btn btn-default}}, source=StateVertexImpl{id=31, name=state31}, target=StateVertexImpl{id=10, name=state10}} */
			formInputs = new ArrayList<FormInput>();
			formInputs.add(new FormInput(FormInput.InputType.TEXT, new Identification(How.id, "0"), "ebUBKXxX"));
			testSuiteHelper.handleFormInputs(formInputs);
			Thread.sleep(100);
	...
	public void method_10_24_25_26_27_28(){
		...
		try {
			...
			formInputs = new ArrayList<FormInput>();
			formInputs.add(new FormInput(FormInput.InputType.TEXT, new Identification(How.id, "0"), "YjdMogkZ"));
			testSuiteHelper.handleFormInputs(formInputs);
			Thread.sleep(100);
			...
			/* Eventable{eventType=click, identification=xpath //FORM[@id = 'specialty']/DIV[2]/DIV[1]/BUTTON[1], element=Element{node=[BUTTON: null], tag=BUTTON, text=Save, attributes={_ngcontent-c3=, class=btn btn-default, type=submit}}, source=StateVertexImpl{id=36, name=state36}, target=StateVertexImpl{id=37, name=state37}} */
			formInputs = new ArrayList<FormInput>();
			formInputs.add(new FormInput(FormInput.InputType.TEXT, new Identification(How.xpath, "/HTML[1]/BODY[1]/APP-ROOT[1]/APP-SPECIALTY-LIST[1]/DIV[1]/DIV[1]/DIV[1]/APP-SPECIALTY-ADD[1]/DIV[1]/DIV[1]/FORM[1]/DIV[2]/DIV[1]/DIV[1]/INPUT[1]"), "dentistry"));
			testSuiteHelper.handleFormInputs(formInputs);
			Thread.sleep(100);
			...
			/* Eventable{eventType=click, identification=xpath //TABLE[@id = 'specialties']/TBODY[1]/TR[1]/TD[2]/BUTTON[1], element=Element{node=[BUTTON: null], tag=BUTTON, text=Edit, attributes={_ngcontent-c2=, class=btn btn-default}}, source=StateVertexImpl{id=37, name=state37}, target=StateVertexImpl{id=38, name=state38}} */
			formInputs = new ArrayList<FormInput>();
			formInputs.add(new FormInput(FormInput.InputType.TEXT, new Identification(How.id, "0"), "jDPNfXEb"));
			testSuiteHelper.handleFormInputs(formInputs);
			Thread.sleep(100);
			...
			/* Eventable{eventType=click, identification=xpath //FORM[@id = 'specialty']/DIV[2]/DIV[1]/BUTTON[1], element=Element{node=[BUTTON: null], tag=BUTTON, text=Update, attributes={_ngcontent-c4=, class=btn btn-default, type=submit}}, source=StateVertexImpl{id=38, name=state38}, target=StateVertexImpl{id=39, name=state39}} */
			formInputs = new ArrayList<FormInput>();
			formInputs.add(new FormInput(FormInput.InputType.TEXT, new Identification(How.xpath, "/HTML[1]/BODY[1]/APP-ROOT[1]/APP-SPECIALTY-EDIT[1]/DIV[1]/DIV[1]/FORM[1]/DIV[2]/DIV[1]/DIV[1]/INPUT[1]"), "surgery"));
			testSuiteHelper.handleFormInputs(formInputs);
			Thread.sleep(100);
			...
			/* Eventable{eventType=click, identification=xpath //TABLE[@id = 'specialties']/TBODY[1]/TR[1]/TD[2]/BUTTON[2], element=Element{node=[BUTTON: null], tag=BUTTON, text=Delete, attributes={_ngcontent-c2=, class=btn btn-default}}, source=StateVertexImpl{id=39, name=state39}, target=StateVertexImpl{id=16, name=state16}} */
			formInputs = new ArrayList<FormInput>();
			formInputs.add(new FormInput(FormInput.InputType.TEXT, new Identification(How.id, "0"), "olEogVcd"));
			testSuiteHelper.handleFormInputs(formInputs);
			Thread.sleep(100);
	...
	public void method_3_36_37_38(){
		...
		try {
			...
			/* Eventable{eventType=click, identification=xpath //FORM[@id = 'vet']/DIV[5]/DIV[1]/BUTTON[1], element=Element{node=[BUTTON: null], tag=BUTTON, text=< Back, attributes={_ngcontent-c2=, class=btn btn-default, type=button}}, source=StateVertexImpl{id=51, name=state51}, target=StateVertexImpl{id=52, name=state52}} */
			formInputs = new ArrayList<FormInput>();
			formInputs.add(new FormInput(FormInput.InputType.TEXT, new Identification(How.xpath, "/HTML[1]/BODY[1]/APP-ROOT[1]/APP-VET-ADD[1]/DIV[1]/DIV[1]/FORM[1]/DIV[2]/DIV[1]/INPUT[1]"), "Rafael"));
			formInputs.add(new FormInput(FormInput.InputType.TEXT, new Identification(How.xpath, "/HTML[1]/BODY[1]/APP-ROOT[1]/APP-VET-ADD[1]/DIV[1]/DIV[1]/FORM[1]/DIV[3]/DIV[1]/INPUT[1]"), "Leary"));
	...
	public void method_3_15_39_40(){
		...
		try {
			...
			/* Eventable{eventType=click, identification=xpath //FORM[@id = 'vet']/DIV[5]/DIV[1]/BUTTON[1], element=Element{node=[BUTTON: null], tag=BUTTON, text=< Back, attributes={_ngcontent-c3=, class=btn btn-default, type=button}}, source=StateVertexImpl{id=55, name=state55}, target=StateVertexImpl{id=23, name=state23}} */
			formInputs = new ArrayList<FormInput>();
			formInputs.add(new FormInput(FormInput.InputType.TEXT, new Identification(How.xpath, "/HTML[1]/BODY[1]/APP-ROOT[1]/APP-VET-ADD[1]/DIV[1]/DIV[1]/FORM[1]/DIV[2]/DIV[1]/INPUT[1]"), "Rafael"));
			formInputs.add(new FormInput(FormInput.InputType.TEXT, new Identification(How.xpath, "/HTML[1]/BODY[1]/APP-ROOT[1]/APP-VET-ADD[1]/DIV[1]/DIV[1]/FORM[1]/DIV[3]/DIV[1]/INPUT[1]"), "Leary"));
			formInputs.add(new FormInput(FormInput.InputType.SELECT, new Identification(How.xpath, "/HTML[1]/BODY[1]/APP-ROOT[1]/APP-VET-ADD[1]/DIV[1]/DIV[1]/FORM[1]/DIV[4]/DIV[1]/DIV[1]/SELECT[1]"), "dentistry"));
	...
	@Test(priority=14)
	public void method_5_41_42_43_44_45(){
		testSuiteHelper.newCurrentTestMethod("method_5_41_42_43_44_45");
		List<FormInput> formInputs;
		...
		try {
			...
			/* Eventable{eventType=click, identification=xpath //FORM[@id = 'pettype']/DIV[2]/DIV[1]/BUTTON[1], element=Element{node=[BUTTON: null], tag=BUTTON, text=Save, attributes={_ngcontent-c3=, class=btn btn-default, type=submit}}, source=StateVertexImpl{id=58, name=state58}, target=StateVertexImpl{id=59, name=state59}} */
			formInputs = new ArrayList<FormInput>();
			formInputs.add(new FormInput(FormInput.InputType.TEXT, new Identification(How.xpath, "/HTML[1]/BODY[1]/APP-ROOT[1]/APP-PETTYPE-LIST[1]/DIV[1]/DIV[1]/DIV[1]/APP-PETTYPE-ADD[1]/DIV[1]/DIV[1]/FORM[1]/DIV[2]/DIV[1]/DIV[1]/INPUT[1]"), "bird"));
			testSuiteHelper.handleFormInputs(formInputs);
			Thread.sleep(100);
			...
			/* Eventable{eventType=click, identification=xpath //TABLE[@id = 'pettypes']/TBODY[1]/TR[1]/TD[2]/BUTTON[1], element=Element{node=[BUTTON: null], tag=BUTTON, text=Edit, attributes={_ngcontent-c2=, class=btn btn-default}}, source=StateVertexImpl{id=59, name=state59}, target=StateVertexImpl{id=60, name=state60}} */
			formInputs = new ArrayList<FormInput>();
			formInputs.add(new FormInput(FormInput.InputType.TEXT, new Identification(How.id, "0"), "oJGanYSQ"));
			testSuiteHelper.handleFormInputs(formInputs);
			Thread.sleep(100);
			...
			/* Eventable{eventType=click, identification=xpath //FORM[@id = 'pettype']/DIV[2]/DIV[1]/BUTTON[1], element=Element{node=[BUTTON: null], tag=BUTTON, text=Update, attributes={_ngcontent-c4=, class=btn btn-default, type=submit}}, source=StateVertexImpl{id=60, name=state60}, target=StateVertexImpl{id=61, name=state61}} */
			formInputs = new ArrayList<FormInput>();
			formInputs.add(new FormInput(FormInput.InputType.TEXT, new Identification(How.xpath, "/HTML[1]/BODY[1]/APP-ROOT[1]/APP-PETTYPE-EDIT[1]/DIV[1]/DIV[1]/FORM[1]/DIV[2]/DIV[1]/DIV[1]/INPUT[1]"), "hamster"));
			testSuiteHelper.handleFormInputs(formInputs);
			Thread.sleep(100);
			...
			/* Eventable{eventType=click, identification=xpath //TABLE[@id = 'pettypes']/TBODY[1]/TR[1]/TD[2]/BUTTON[2], element=Element{node=[BUTTON: null], tag=BUTTON, text=Delete, attributes={_ngcontent-c2=, class=btn btn-default}}, source=StateVertexImpl{id=61, name=state61}, target=StateVertexImpl{id=8, name=state8}} */
			formInputs = new ArrayList<FormInput>();
			formInputs.add(new FormInput(FormInput.InputType.TEXT, new Identification(How.id, "0"), "bzQIhbZE"));
			testSuiteHelper.handleFormInputs(formInputs);
			Thread.sleep(100);
			Assert.assertTrue(testSuiteHelper.fireEvent(45), "Event fired: Delete");
			testSuiteHelper.runInCrawlingPlugins(8);
			Assert.assertTrue(testSuiteHelper.checkInvariants(), "Invariants satisfied in state: 8");
	...
	@Test(priority=15)
	public void method_5_6_18_46(){
		testSuiteHelper.newCurrentTestMethod("method_5_6_18_46");
		List<FormInput> formInputs;
		...
		try {
			...
			testSuiteHelper.handleFormInputs(formInputs);
			Thread.sleep(100);
			Assert.assertTrue(testSuiteHelper.fireEvent(46), "Event fired: Home");
			testSuiteHelper.runInCrawlingPlugins(14);
			Assert.assertTrue(testSuiteHelper.checkInvariants(), "Invariants satisfied in state: 14");
	...
	@Test(priority=16)
	public void method_5_6_18_19_47(){
		testSuiteHelper.newCurrentTestMethod("method_5_6_18_19_47");
		List<FormInput> formInputs;
		...
		try {
			...
			/* Eventable{eventType=click, identification=xpath //TABLE[@id = 'specialties']/TBODY[1]/TR[1]/TD[2]/BUTTON[2], element=Element{node=[BUTTON: null], tag=BUTTON, text=Delete, attributes={_ngcontent-c4=, class=btn btn-default}}, source=StateVertexImpl{id=29, name=state29}, target=StateVertexImpl{id=10, name=state10}} */
			formInputs = new ArrayList<FormInput>();
			formInputs.add(new FormInput(FormInput.InputType.TEXT, new Identification(How.id, "0"), "ULKMQcqj"));
			testSuiteHelper.handleFormInputs(formInputs);
			Thread.sleep(100);
			Assert.assertTrue(testSuiteHelper.fireEvent(47), "Event fired: Delete");
			testSuiteHelper.runInCrawlingPlugins(10);
			Assert.assertTrue(testSuiteHelper.checkInvariants(), "Invariants satisfied in state: 10");
	...
	@Test(priority=17)
	public void method_5_6_18_19_20_48(){
		testSuiteHelper.newCurrentTestMethod("method_5_6_18_19_20_48");
		List<FormInput> formInputs;
		...
		try {
			...
			/* Eventable{eventType=click, identification=xpath //FORM[@id = 'specialty']/DIV[2]/DIV[1]/BUTTON[2], element=Element{node=[BUTTON: null], tag=BUTTON, text=Cancel, attributes={_ngcontent-c6=, class=btn btn-default}}, source=StateVertexImpl{id=30, name=state30}, target=StateVertexImpl{id=68, name=state68}} */
			formInputs = new ArrayList<FormInput>();
			formInputs.add(new FormInput(FormInput.InputType.TEXT, new Identification(How.xpath, "/HTML[1]/BODY[1]/APP-ROOT[1]/APP-SPECIALTY-EDIT[1]/DIV[1]/DIV[1]/FORM[1]/DIV[2]/DIV[1]/DIV[1]/INPUT[1]"), "surgery"));
			testSuiteHelper.handleFormInputs(formInputs);
			Thread.sleep(100);
	...
	public void method_5(){
		testSuiteHelper.newCurrentTestMethod("method_5");
		List<FormInput> formInputs;
	...
	@Test(priority=19)
	public void method_10_24_49(){
		testSuiteHelper.newCurrentTestMethod("method_10_24_49");
		List<FormInput> formInputs;
		...
		try {
			...
			formInputs = new ArrayList<FormInput>();
			formInputs.add(new FormInput(FormInput.InputType.TEXT, new Identification(How.id, "0"), "tqOLoKXt"));
			formInputs.add(new FormInput(FormInput.InputType.TEXT, new Identification(How.xpath, "/HTML[1]/BODY[1]/APP-ROOT[1]/APP-SPECIALTY-LIST[1]/DIV[1]/DIV[1]/DIV[1]/APP-SPECIALTY-ADD[1]/DIV[1]/DIV[1]/FORM[1]/DIV[2]/DIV[1]/DIV[1]/INPUT[1]"), "dentistry"));
			testSuiteHelper.handleFormInputs(formInputs);
			Thread.sleep(100);
