...
public interface EmbeddedBrowser {
	...
	/**
	 * Signals the end of a crawl path
	 * @param separator string to use to separate crawl paths in the file where driver actions are written
	 * */
	void crawlPathEnd(String separator);
