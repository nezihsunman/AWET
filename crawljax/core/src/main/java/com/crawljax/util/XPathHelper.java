...
public final class XPathHelper {
	...
	public static boolean disableIdAndNameIdentification = false;

	public static String getAbsoluteXPathExpression(Node node) {
		...
		if (parent != node) {
			buffer.append(getAbsoluteXPathExpression(parent));
			buffer.append("/");
		}
	...
	public static String getXPathExpression(Node node) {
		...
		if(!XPathHelper.disableIdAndNameIdentification) {
