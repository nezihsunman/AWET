...
public class CrawlRules {
	...
	public static final class CrawlRulesBuilder {
		...
		public CrawlRulesBuilder setInputFieldIdsWithEnterClick(Set<Identification> inputFieldIdsWithEnterClick) {
		    crawlRules.inputFieldIdsWithEnterClick = new HashSet<>(inputFieldIdsWithEnterClick);
		    return this;
        }

		public CrawlRulesBuilder setDisableIdAndNameIdentification(boolean disableIdAndNameIdentification) {
			crawlRules.disableIdAndNameIdentification = disableIdAndNameIdentification;
			XPathHelper.disableIdAndNameIdentification = disableIdAndNameIdentification;
			return this;
		}
	...
	private boolean disableIdAndNameIdentification = false;
	private Set<Identification> inputFieldIdsWithEnterClick = new HashSet<>();
	...
	public boolean isDisableIdAndNameIdentification() { return disableIdAndNameIdentification; }

    public Set<Identification> getInputFieldIdsWithEnterClick() { return new HashSet<>(inputFieldIdsWithEnterClick); }
