...
public class Properties {
    ...
    public final static String coverageInterLineSeparator = "{{coverage_inter_line_separator}}";
    public final static String summaryLineCoverageReportStart = "{{summary_line_coverage_report_start}}";
