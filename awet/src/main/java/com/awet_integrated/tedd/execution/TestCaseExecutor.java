...
public class TestCaseExecutor<T> {
    ...
    public TestCaseExecutor(){
        ...
        String testsPath = Properties.TEST_SUITE_PATH;
...
//        }
    ...
    private Map.Entry<Integer, List<String>> remoteExecutionWithJUnitCore(List<String> schedule)
        ...
        try (ServerSocket server = new ServerSocket(0)) {
            ...
            args.add("--tests-path");
            args.add(Properties.TEST_SUITE_PATH);
            ...
            args.add("--stop-execution-first-failure");
            args.add(String.valueOf(Properties.STOP_EXECUTION_FIRST_FAILURE));
