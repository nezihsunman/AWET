...
public class GraphNode<T> {
    ...
    public GraphNode<T> clone(){
        return new GraphNode<>(this.testCase, this.numOrder);
        // fails when T is a String, maybe use ObjectUtils.clone when T is a custom class
        // GraphNode<T> clone = new GraphNode<>(ObjectUtils.clone(this.testCase), this.numOrder);
    }
}
