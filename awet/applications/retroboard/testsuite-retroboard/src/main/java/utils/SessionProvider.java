...
public class SessionProvider {
    ...
    public String getResourceFromApp(URL url, String resourceName) {
        File scriptFile = new File(Properties.user_dir + "src/main/resources/" + resourceName);
        ...
        try {
            ...
            this.scriptSource = reader.lines().collect(Collectors.joining("\n"));
            FileUtils.writeFile(this.scriptSource, Properties.user_dir + "/src/main/resources/" + resourceName);
            return this.scriptSource;
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
